...
export const NOVEL_CHAPTERS: Chapter[] = [
  {
    ...
    scenes: [
      ...
      },
      {
        id: 1,
        character: "aria",
        text: "I can't believe it... I'm actually here. The Albert Park paddock. Formula 1. Me, Gina Voss, in Formula 1!",
        emotion: "excited",
        autoAdvance: true,
      },
      {
        ...
        choices: [
          {
            ...
            pointCost: 0,
            affectionGain: 10,
            response: "Gina smiles warmly. 'Thank you. I needed to hear that more than you know.'",
          },
          {
            id: "ch1_s2_b",
            ...
            pointCost: 500,
            affectionGain: 25,
            response: "Gina laughs in surprise. 'A little helmet charm! I'm going to keep this on my visor. Thank you so much!'",
          },
          {
            id: "ch1_s2_c",
            ...
            pointCost: 1000,
            affectionGain: 50,
            response: "Gina's eyes light up. 'You'd do that? Stay up all night going through lap data with me? You're incredible. Let's go!'",
          },
        ],
      },
      {
    ...
    scenes: [
      {
        id: 0,
        character: "narrator",
        text: "Saturday afternoon. Q1 is about to begin. The temperature on track is 42 degrees and Gina's car sits in the pit lane, ready to fire.",
        emotion: "default",
        autoAdvance: true,
      },
      {
        ...
        choices: [
          {
            ...
            pointCost: 0,
            affectionGain: 10,
            response: "Gina nods. 'Makes sense. A click of front wing should give me more front-end bite. Good thinking!'",
          },
          {
            id: "ch2_s2_b",
            ...
            pointCost: 800,
            affectionGain: 30,
            response: "The consultant's advice is gold. Gina switches to a different tyre compound option and suddenly the car feels alive. 'This is it! This is the setup!'",
          },
          {
            id: "ch2_s2_c",
            ...
            pointCost: 2000,
            affectionGain: 60,
            response: "'Three tenths faster in sector two alone!' Gina screams over the radio. 'I'm on for a shock Q3 appearance!' She goes on to qualify eighth — a sensation.",
          },
        ],
      },
      {
    ...
    scenes: [
      {
        id: 0,
        character: "narrator",
        text: "Race day. The grid is formed, engines warming, the crowd a sea of colour. Gina sits in her car, P12, helmet on, visor down. This is what she was born for.",
        emotion: "default",
        autoAdvance: true,
      },
      {
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            pointCost: 2500,
            affectionGain: 70,
            response: "The real-time analysis is incredible. The team predicts a safety car in five laps — they're right. Gina pits under it, leapfrogs two cars, and finishes P6. SIX POINTS on debut!",
          },
        ],
      },
      {
    ...
    scenes: [
      {
        id: 0,
        character: "narrator",
        text: "The Melbourne result sent shockwaves through the paddock. Now everyone wants a piece of Gina Voss. The press conference room is packed.",
        emotion: "default",
        autoAdvance: true,
      },
      {
        ...
        choices: [
          {
            ...
            pointCost: 0,
            affectionGain: 15,
            response: "Gina squares her shoulders. 'You're right. Numbers don't lie. And my numbers say I belong here.' A ripple of applause from the room.",
          },
          {
            id: "ch4_s2_b",
            ...
            pointCost: 1200,
            affectionGain: 40,
            response: "Armed with perfect talking points, Gina handles every question with grace and confidence. 'I earned my seat on merit. Every lap tells that story.' The room is won over.",
          },
          {
            id: "ch4_s2_c",
            ...
            pointCost: 3000,
            affectionGain: 80,
            response: "The interview becomes the most-watched F1 content of the year. Gina's story — from karting at age 8 to Melbourne — moves millions. The narrative shifts completely in her favour.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            pointCost: 0,
            affectionGain: 20,
            response: "Gina holds Hamilton at bay by 0.3 seconds at the line. The barriers scrape her sidepod — she doesn't care. PODIUM. The crowd erupts.",
          },
          {
            id: "ch5_s2_b",
            ...
            pointCost: 1500,
            affectionGain: 50,
            response: "Using the data, Gina finds time in Portier and the chicane. She actually gaps Hamilton by 1.2 seconds at the flag. Third place. Podium. She weeps openly on the top step.",
          },
          {
            id: "ch5_s2_c",
            ...
            pointCost: 4000,
            affectionGain: 100,
            response: "With the expert guiding her, she pulls something extraordinary — she attacks Hamilton and takes second! SECOND AT MONACO on her debut appearance. The grandstands go berserk. Gina stands on the podium, trophy raised, tears streaming, looking straight at you.",
          },
        ],
      },
      {
